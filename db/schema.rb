...
ActiveRecord::Schema[7.2].define(version: 2025_09_30_124630) do
  ...
  create_enum "future_interest_type", %w[yes no unknown]
  create_enum "trigger_type", %w[provider trainee]
  ...
  create_table "bulk_update_row_errors", force: :cascade do |t|
    ...
    t.index(%w[errored_on_id errored_on_type], name: "idx_on_errored_on_id_errored_on_type_492045ed60")
  end
  ...
  create_table "bulk_update_trainee_upload_rows", force: :cascade do |t|
    ...
    t.datetime("created_at", null: false)
    t.datetime("updated_at", null: false)
    t.index(%w[bulk_update_trainee_upload_id row_number], name: "index_bulk_update_trainee_upload_rows_on_upload_and_row_number", unique: true)
  ...
  create_table "course_subjects", force: :cascade do |t|
    ...
    t.datetime("created_at", null: false)
    t.datetime("updated_at", null: false)
    t.index(%w[course_id subject_id], name: "index_course_subjects_on_course_id_and_subject_id", unique: true)
  ...
  create_table "courses", force: :cascade do |t|
    ...
    t.index(%w[code accredited_body_code], name: "index_courses_on_code_and_accredited_body_code")
  ...
  create_table "funding_method_subjects", force: :cascade do |t|
    ...
    t.datetime("created_at", null: false)
    t.datetime("updated_at", null: false)
    t.index(%w[allocation_subject_id funding_method_id], name: "index_funding_methods_subjects_on_ids", unique: true)
  ...
  create_table "funding_payment_schedules", force: :cascade do |t|
    ...
    t.datetime("created_at", null: false)
    t.datetime("updated_at", null: false)
    t.index(%w[payable_id payable_type], name: "index_funding_payment_schedules_on_payable_id_and_payable_type")
  end
  ...
  create_table "funding_trainee_summaries", force: :cascade do |t|
    ...
    t.datetime("created_at", null: false)
    t.datetime("updated_at", null: false)
    t.index(%w[payable_id payable_type], name: "index_funding_trainee_summaries_on_payable_id_and_payable_type")
  end
  ...
  create_table "placements", force: :cascade do |t|
    ...
    t.index(%w[slug trainee_id], name: "index_placements_on_slug_and_trainee_id", unique: true)
  ...
  create_table "provider_users", force: :cascade do |t|
    ...
    t.datetime("created_at", null: false)
    t.datetime("updated_at", null: false)
    t.index(%w[provider_id user_id], name: "index_provider_users_on_provider_id_and_user_id", unique: true)
  ...
  create_table "sign_offs", force: :cascade do |t|
    ...
    t.index(%w[provider_id academic_cycle_id sign_off_type], name: "idx_on_provider_id_academic_cycle_id_sign_off_type_fc3b6ade67", unique: true)
  ...
  create_table "trainee_disabilities", force: :cascade do |t|
    ...
    t.index(%w[disability_id trainee_id], name: "index_trainee_disabilities_on_disability_id_and_trainee_id", unique: true)
  ...
  create_table "trainee_withdrawal_reasons", force: :cascade do |t|
    ...
    t.index(%w[trainee_id withdrawal_reason_id], name: "uniq_idx_trainee_withdawal_reasons", unique: true)
    t.index(["trainee_id"], name: "index_trainee_withdrawal_reasons_on_trainee_id")
    t.index(%w[trainee_withdrawal_id withdrawal_reason_id], name: "uniq_idx_trainee_withdrawal_id_withdrawal_reason_id", unique: true)
  ...
  create_table "trainees", force: :cascade do |t|
    ...
    t.index(%w[discarded_at record_source provider_id state], name: "index_trainees_on_discarded_at__record_source__provider__state")
