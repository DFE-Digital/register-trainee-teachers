...
ActiveRecord::Schema.define(version: 2022_04_11_153936) do
  ...
  create_table "payment_profile_row_amounts", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["payment_profile_row_id"], name: "index_payment_profile_row_amounts_on_payment_profile_row_id"
  end
  ...
  create_table "trainee_payment_summary_row_amounts", force: :cascade do |t|
    t.integer "trainee_payment_summary_row_id"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["trainee_payment_summary_row_id"], name: "index_trainee_payment_row_amounts_on_trainee_payment_row_id"
  end

  create_table "trainee_payment_summary_rows", force: :cascade do |t|
    t.integer "trainee_payment_summary_id"
    t.string "subject"
    t.string "route"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["trainee_payment_summary_id"], name: "index_trainee_payment_rows_on_trainee_payment_summary_id"
  end
