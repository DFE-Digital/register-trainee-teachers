  ...
  def up
    Trainee.joins(:hesa_students).find_each do |trainee|
      ...
      if schools.present?
        ...
        # Else we must be getting a not applicable urn. See the list here: Trainees::CreateFromHesa::NOT_APPLICABLE_SCHOOL_URNS
        hesa_urns.each do |urn|
          # Skip if the urn is not among Trainees::CreateFromHesa::NOT_APPLICABLE_SCHOOL_URNS
