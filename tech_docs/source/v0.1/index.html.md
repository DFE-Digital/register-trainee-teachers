...
- [Endpoints](#endpoints)
    - [GET /info](#get-info)
    - [GET /trainees](#get-trainees)
    - [GET /trainees/{trainee_id}](#get-trainees-trainee-id)
    - [GET /trainees/{trainee_id}/placements](#get-trainees-trainee-id-placements)
    - [GET /trainees/{trainee_id}/placements/{placement_id}](#get-trainees-trainee-id-placements-placement-id)
    - [GET /trainees/{trainee_id}/degrees](#get-trainees-trainee-id-degrees)
    - [GET /trainees/{trainee_id}/degrees/{degree_id}](#get-trainees-trainee-id-degrees-degree-id)
    - [POST /trainees](#post-trainees)
    - [POST /trainees/{trainee_id}/placements](#post-trainees-trainee-id-placements)
    - [POST /trainees/{trainee_id}/degrees](#post-trainees-trainee-id-degrees)
    - [POST /trainees/{trainee_id}/recommend-for-qts](#post-trainees-trainee-id-recommend-for-qts)
    - [POST /trainees/{trainee_id}/defer](#post-trainees-trainee-id-defer)
    - [POST /trainees/{trainee_id}/withdraw](#post-trainees-trainee-id-withdraw)
    - [PUT|PATCH /trainees/{trainee_id}](#put-patch-trainees-trainee-id)
    - [PUT|PATCH /trainees/{trainee_id}/placements/{placement_id}](#put-patch-trainees-trainee-id-placements-placement-id)
    - [PUT|PATCH /trainees/{trainee_id}/degrees/{degree_id}](#put-patch-trainees-trainee-id-degrees-degree-id)
    - [DELETE /trainees/{trainee_id}/placements/{placement_id}](#delete-trainees-trainee-id-placements-placement-id)
    - [DELETE /trainees/{trainee_id}/degrees/{degree_id}](#delete-trainees-trainee-id-degrees-degree-id)
- [Objects](#objects)
