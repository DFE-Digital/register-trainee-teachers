...
<p><a href="/reference-data/v2025.0/fund_code/download">Download valid entries as a CSV file</a></p>
...
<table class="govuk-table">
  ...
  <tbody class="govuk-table__body">
      ...
      <tr class="govuk-table__row">
        ...
        <td class="govuk-table__cell">Eligible for student finance (use this option if the trainee chooses not to receive the finance they are eligible for)</td>
      </tr>
  </tbody>
</table>
