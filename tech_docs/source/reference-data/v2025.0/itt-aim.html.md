...
<p><a href="/reference-data/v2025.0/itt_aim/download">Download valid entries as a CSV file</a></p>
...
<table class="govuk-table">
  ...
  <tbody class="govuk-table__body">
      <tr class="govuk-table__row">
        ...
        <td class="govuk-table__cell">Professional status only</td>
      </tr>
      <tr class="govuk-table__row">
        <td class="govuk-table__cell">202</td>
        <td class="govuk-table__cell">Both professional status and academic award</td>
      </tr>
  </tbody>
</table>
