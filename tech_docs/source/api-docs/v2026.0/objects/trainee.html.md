    ...
    <dd class="govuk-summary-list__value">
      ...
      <p class="govuk-body">
        The sex of the trainee. Coded according to the <a
          href="/reference-data/v2026.0/sex.html">Sex reference data specification</a>.
      </p>
      <p class="govuk-body">
    ...
    <dd class="govuk-summary-list__value">
      ...
      <p class="govuk-body">
        The nationality of the trainee. Coded according to the <a
          href="/reference-data/v2026.0/nationality.html">Nationality reference data specification</a>.
      </p>
      <p class="govuk-body">
    ...
    <dd class="govuk-summary-list__value">
      ...
      <p class="govuk-body">
        The ethnicity of the trainee. Coded according to the <a
          href="/reference-data/v2026.0/ethnicity.html">Ethnicity reference data specification</a>. The values for
    ...
    <dd class="govuk-summary-list__value">
      ...
      <p class="govuk-body">
        The type of disabilities that the trainee has. Coded according to the <a
          href="/reference-data/v2026.0/disability1.html">Disability reference data specification</a>
      </p>
      <p class="govuk-body">
    ...
    <dd class="govuk-summary-list__value">
      ...
      <p class="govuk-body">
        The general qualification aim of the course in terms of qualifications and professional statuses. Coded according to the <a
          href="/reference-data/v2026.0/itt-aim.html">ITT Aim reference data specification</a>
      </p>
      <p class="govuk-body">
    ...
    <dd class="govuk-summary-list__value">
      ...
      <p class="govuk-body">
        The training route that the trainee is on. Coded according to the <a
          href="/reference-data/v2026.0/training-route.html">Training Route reference data specification</a>
      </p>
      <p class="govuk-body">
    ...
    <dd class="govuk-summary-list__value">
      ...
      <p class="govuk-body">
        The qualification aim of the trainee’s course. Coded according to the <a
          href="/reference-data/v2026.0/itt-qualification-aim.html">Qualification Aim reference data specification</a>
      </p>
      <p class="govuk-body">
    ...
    <dd class="govuk-summary-list__value">
      ...
      <p class="govuk-body">
        ...
        scholarship available if applicable. Coded according to the <a
          href="/reference-data/v2026.0/course-subject-one.html">Course Subject reference data specification</a>.
      </p>
      <p class="govuk-body">
        Notes:
        Where the course maximum age is 11 or less as stated in <code>course_age_range</code>,
        we expect <code>course_subject_one</code> to be “Primary Teaching”. We will return an error if this is not set to HESA code <code>100511</code>.
      </p>
      <p class="govuk-body">
    ...
    <dd class="govuk-summary-list__value">
      ...
      <p class="govuk-body">
        This indicates whether the trainee’s course is full-time or part-time. Coded according to the <a
          href="/reference-data/v2026.0/study-mode.html">Study Mode reference data specification</a>
      </p>
      <p class="govuk-body">
    ...
    <dd class="govuk-summary-list__value">
      ...
      <p class="govuk-body">
        The age range of children taught on the course. Coded according to the <a
          href="/reference-data/v2026.0/course-age-range.html">Course Age Range reference data specification</a>
      </p>
      <p class="govuk-body">
    ...
    <dd class="govuk-summary-list__value">
      ...
      <p class="govuk-body">
        The bursary level awarded to the trainee. Coded according to the <a
          href="/reference-data/v2026.0/funding-method.html">Funding Method reference data specification</a>
      </p>
      <p class="govuk-body">
        Example: <code>4</code>
      </p>
    ...
    <dd class="govuk-summary-list__value">
      ...
      <p class="govuk-body">
        ...
        to reflect current schemes. Coded according to the <a
          href="/reference-data/v2026.0/training-initiative.html">Training Initiative reference data specification</a>
      </p>
      <p class="govuk-body">
