    ...
    <dd class="govuk-summary-list__value">
      ...
      <p class="govuk-body">
        The type of disabilities that the trainee has. Coded according to the <a
          href="/reference-data/v2026.0/disability.html">Disability reference data specification</a>
      </p>
      <p class="govuk-body">
    ...
    <dd class="govuk-summary-list__value">
      ...
      <p class="govuk-body">
        ...
        scholarship available if applicable. Coded according to the <a
          href="/reference-data/v2026.0/course-subject.html">Course Subject reference data specification</a>.
      </p>
      <p class="govuk-body">
        Notes:
