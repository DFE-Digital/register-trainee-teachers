  ...
  <div class="app-summary-card__body">
    <dl class="govuk-summary-list">
      ...
      <div class="govuk-summary-list__row hesa-alignment govuk-summary-list__row--no-actions" id="hesa-alignment">
        <dt class="govuk-summary-list__key">HESA alignment</dt><dd class="govuk-summary-list__value">NQTEMAIL</dd>
      </div>
      <div class="govuk-summary-list__row description govuk-summary-list__row--no-actions" id="description">
        <dt class="govuk-summary-list__key">Description</dt>
        <dd class="govuk-summary-list__value">
          <p>This field collects the personal email address for a trainee on their Initial Teacher Training course.

This must be a trainee’s personal email address. DfE uses this to communicate to trainees after they have left their training course, for example, regarding their QTS.</p>
        </dd>
      </div>
      ...
      <div class="govuk-summary-list__row example govuk-summary-list__row--no-actions" id="example">
        ...
        <dd class="govuk-summary-list__value">
          <p>&ldquo;jane.smith@example.com&rdquo;</p>
        </dd>
      </div>
