  ...
  <div class="app-summary-card__body">
    <dl class="govuk-summary-list">
      <div class="govuk-summary-list__row csv-field-name govuk-summary-list__row--no-actions" id="csv-field-name">
        ...
        <dd class="govuk-summary-list__value">Course Age Range</dd>
      </div>
      <div class="govuk-summary-list__row api-field-name govuk-summary-list__row--no-actions" id="api-field-name">
        ...
        <dd class="govuk-summary-list__value">course_age_range</dd>
      </div>
      <div class="govuk-summary-list__row hesa-alignment govuk-summary-list__row--no-actions" id="hesa-alignment">
        <dt class="govuk-summary-list__key">HESA alignment</dt><dd class="govuk-summary-list__value">ITTPHSC</dd>
      </div>
      <div class="govuk-summary-list__row description govuk-summary-list__row--no-actions" id="description">
        <dt class="govuk-summary-list__key">Description</dt>
        <dd class="govuk-summary-list__value">
          <p>This field describes in more detail the student’s initial teacher training aim</p>
        </dd>
      </div>
      <div class="govuk-summary-list__row format govuk-summary-list__row--no-actions" id="format">
        ...
        <dd class="govuk-summary-list__value">
          <p>&ldquo;[HESA course phase reference codes](https://www.hesa.ac.uk/collection/c24053/e/ittphsc)&rdquo;
...
The following HESA values are invalid for this field:
  ...
  - `99803` - Teacher training qualification: Other</p>
        </dd>
      </div>
      <div class="govuk-summary-list__row example govuk-summary-list__row--no-actions" id="example">
        ...
        <dd class="govuk-summary-list__value">
          <p>&ldquo;13916&rdquo; for example is the code used for Accredited by the Department for Education (DfE) for the purpose of delivering initial teacher training programmes to achieve Qualified Teacher Status (QTS): Ages 7-14</p>
        </dd>
      </div>
