        ...
        private
          ...
          def funding_method_exists?
            ...
            @funding_method_exists ||= ::FundingMethod.joins(allocation_subjects: :subject_specialisms).exists?(
              ...
              training_route: training_route.is_a?(Api::V20260::HesaMapper::Attributes::InvalidValue) ? nil : training_route,
              subject_specialisms: { name: course_subject_one.is_a?(Api::V20260::HesaMapper::Attributes::InvalidValue) ? nil : course_subject_one },
            )
          end
