  ...
  module CodeSets
    module AgeRanges
      MAPPING = {
        ...
        AgeRange::FIVE_TO_FOURTEEN => { entity_id: "187ee9f5-569c-e711-80d9-005056ac45bb", option: :additional, levels: %i[primary secondary] },
        AgeRange::FIVE_TO_EIGHTEEN => { entity_id: "eb8edb1d-9e35-ec11-8c64-000d3ab973d7", option: :additional, levels: [:secondary] },
        AgeRange::SEVEN_TO_ELEVEN => { entity_id: "fad38a88-8ec0-e611-80be-00155d010316", option: :additional, levels: [:primary] },
        AgeRange::SEVEN_TO_FOURTEEN => { entity_id: "fbd38a88-8ec0-e611-80be-00155d010316", option: :additional, levels: %i[primary secondary] },
