...
class School < ApplicationRecord
  ...
  has_many :lead_school_trainees, class_name: "Trainee", foreign_key: :lead_school_id
  has_many :employing_school_trainees, class_name: "Trainee", foreign_key: :employing_school_id
