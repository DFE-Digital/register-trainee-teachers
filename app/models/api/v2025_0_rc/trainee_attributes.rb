...
module Api
  module V20250Rc
    class TraineeAttributes
      ...
      # v2025.0-rc specific validations
      ...
      # v2025.0-rc version with record_source support
    ...
    private
      ...
      # v2025.0-rc specific validation methods
      def require_subject?
      ...
      def set_course_allocation_subject_id
        return course_subject_one if course_subject_one.is_a?(Api::V20250Rc::HesaMapper::Attributes::InvalidValue)
