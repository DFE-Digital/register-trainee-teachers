...
class TrainingDetailsForm < TraineeForm
  COMMENCEMENT_DATE_OPTION_COURSE = "course"
  COMMENCEMENT_DATE_OPTION_MANUAL = "manual"

  attr_accessor :trainee_id, :day, :month, :year, :commencement_date_option

  delegate :course_start_date, to: :trainee

  validates :commencement_date_option, inclusion: { in: [COMMENCEMENT_DATE_OPTION_COURSE, COMMENCEMENT_DATE_OPTION_MANUAL] }, if: :course_start_date
  ...
  def commencement_date
    if commencement_date_option == COMMENCEMENT_DATE_OPTION_COURSE
      course_start_date
    else
...
private
  ...
  def compute_fields
    {
      ...
      commencement_date_option: compute_commencement_date_option,
    }.merge(new_attributes.slice(:trainee_id, :day, :month, :year, :commencement_date_option))
  end

  def compute_commencement_date_option
    return unless trainee.commencement_date

    course_start_date == trainee.commencement_date ? COMMENCEMENT_DATE_OPTION_COURSE : COMMENCEMENT_DATE_OPTION_MANUAL
  end
  ...
  def commencement_date_valid
    return if commencement_date_option == COMMENCEMENT_DATE_OPTION_COURSE
