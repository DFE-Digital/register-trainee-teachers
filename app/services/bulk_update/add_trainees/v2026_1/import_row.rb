    ...
    module V20261
      class ImportRow
        ...
        def call
          ...
          attributes = V20261::ImportRows::ALL_HEADERS.to_h do |header_name, attribute_name|
      ...
      private
        ...
        def prepare_csv_attributes_for_api(attributes)
          ...
          attributes[:training_partner_not_applicable] = attributes[:training_partner_urn].blank?
