    ...
    module V20260
      class ImportRows < BulkUpdate::AddTrainees::ImportRows
        ...
        TRAINEE_HEADERS = {
          ...
          "ethnicity" => "ethnicity",
          "disability_1" => "disability1",
          "disability_2" => "disability2",
          "disability_3" => "disability3",
          "disability_4" => "disability4",
          "disability_5" => "disability5",
          "disability_6" => "disability6",
          "disability_7" => "disability7",
          "disability_8" => "disability8",
          "disability_9" => "disability9",
          "itt_aim" => "itt_aim",
