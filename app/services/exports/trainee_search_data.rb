    ...
    def format_trainees(trainees)
      ...
      Trainee.where(id: trainees.pluck(:id)).includes(:apply_application, :degrees, :end_academic_cycle, :nationalities, :provider, :start_academic_cycle).find_each do |trainee|
        ...
        formatted_trainees << {
          ...
          "register_record_last_changed_at" => trainee.updated_at&.iso8601,
          "hesa_record_last_changed_at" => trainee.hesa_updated_at&.iso8601,
          ...
          "sex" => sex(trainee),
          "nationality" => trainee.nationalities.pluck(:name).map(&:titleize).join(", "),
          ...
          "degree_1_type_uk" => degree&.uk_degree,
          "degree_1_type_non_uk" => degree&.non_uk_degree,
          ...
          "course_training_route" => course_route(trainee),
          ...
          "course_subject_category" => trainee_allocation_subject(trainee.course_subject_one) || course_allocation_subject(course),
          ...
          "course_minimum_age" => trainee.course_min_age,
          "course_maximum_age" => trainee.course_max_age,
          "course_full_or_part_time" => course_study_mode(trainee),
          "course_level" => course_level(trainee),
          "itt_start_date" => trainee.itt_start_date&.iso8601,
          "expected_end_date" => itt_end_date(trainee),
          "course_duration_in_years" => trainee.course_duration_in_years,
          "course_award" => course_summary(trainee, course),
          ...
          "award_given_at" => awarded_at(trainee),
          "defer_date" => defer_date(trainee),
          "return_from_deferral_date" => trainee.reinstate_date&.iso8601,
