    ...
    module HesaMapper
      ...
      private
        ...
        def degrees_attributes
          params[:degrees_attributes]&.map { |degree| Api::V20250Rc::HesaMapper::DegreeAttributes.call(degree) }
        end

        def placements_attributes
          params[:placements_attributes]&.map { |placement| Api::V20250Rc::HesaMapper::PlacementAttributes.new(placement).call }
        end
