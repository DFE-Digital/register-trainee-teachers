  ...
  module V20250Rc
    module HesaMapper
      ...
      private
        ...
        def uk_degree
          return Api::V20250Rc::HesaMapper::Attributes::InvalidValue.new(@params[:uk_degree]) if @params[:uk_degree].present? && uk_degree_type.blank?
        ...
        def non_uk_degree
          return Api::V20250Rc::HesaMapper::Attributes::InvalidValue.new(@params[:non_uk_degree]) if @params[:non_uk_degree].present? && non_uk_degree_type.blank?
        ...
        def country_from_mapping
          @country_from_mapping ||= begin
            ...
            if @params[:country].present? && mapped_value.nil?
              Api::V20250Rc::HesaMapper::Attributes::InvalidValue.new(@params[:country])
            else
              mapped_value
            end
          end
