...
module Api
  class CreateTrainee
    ...
    def call
      ...
      validator = trn_validator(trainee)

      if validator_valid?(validator) && trainee.save
  ...
  private
    ...
    def save_errors_response(validator, trainee)
      validation_errors = validator&.all_errors.presence || trainee.errors.full_messages
