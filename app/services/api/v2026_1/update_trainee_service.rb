  ...
  module V20261
    class UpdateTraineeService
      ...
      def call
        ...
        clear_iqts_country if route_changed_from_iqts?
    ...
    private
      ...
      def route_changed_from_iqts?
        trainee.iqts? && attributes.training_route != TRAINING_ROUTE_ENUMS[:iqts]
      end

      def clear_iqts_country
        attributes.iqts_country = nil
      end
    end
  end
end
