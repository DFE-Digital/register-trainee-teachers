...
module SystemAdmin
  class FundingUploadsController < ApplicationController
    ...
    def index
      @lead_partner_trainee_summary = FundingUpload.recently_processed_upload_for(:lead_school_trainee_summary)
      @lead_partner_payment_schedule = FundingUpload.recently_processed_upload_for(:lead_school_payment_schedule)
