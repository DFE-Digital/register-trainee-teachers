...
You can sign into Register to change a trainee’s QTS or EYTS status from within their trainee record. You can also change the status of multiple trainees at the same time. Find out [how to change trainee status for QTS or EYTS in bulk](/guidance/bulk-change-trainee-status).
