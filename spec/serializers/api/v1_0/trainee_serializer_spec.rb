...
RSpec.describe Api::V10::TraineeSerializer do
  ...
  describe "serialization" do
    ...
    describe "placements" do
      let(:placements) do
        trainee.placements.map { |placement| Api::V10::PlacementSerializer.new(placement).as_hash.with_indifferent_access }
      end

      it "serializes with Api::V10::PlacementSerializer" do
    ...
    describe "degrees" do
      let(:degrees) do
        trainee.degrees.map { |degree| Api::V10::DegreeSerializer.new(degree).as_hash.with_indifferent_access }
      end

      it "serializes with Api::V10::DegreeSerializer" do
    ...
    describe "HESA trainee details" do
      let(:hesa_trainee_detail) do
        Api::V10::HesaTraineeDetailSerializer.new(trainee.hesa_trainee_detail).as_hash.with_indifferent_access
      end

      it "serializes with Api::V10::HesaTraineeDetailSerializer" do
        expect(trainee.hesa_trainee_detail.attributes.except(*Api::V10::HesaTraineeDetailSerializer::EXCLUDED_ATTRIBUTES)).to eq(hesa_trainee_detail)
      end
    end
