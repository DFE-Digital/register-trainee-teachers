...
RSpec.describe Api::V20261::TraineeSerializer do
  ...
  describe "serialization" do
    ...
    describe "placements" do
      let(:placements) do
        trainee.placements.map { |placement| Api::V20261::PlacementSerializer.new(placement).as_hash.with_indifferent_access }
      end

      it "serializes with Api::V20261::PlacementSerializer" do
    ...
    describe "degrees" do
      let(:degrees) do
        trainee.degrees.map { |degree| Api::V20261::DegreeSerializer.new(degree).as_hash.with_indifferent_access }
      end

      it "serializes with Api::V20261::DegreeSerializer" do
