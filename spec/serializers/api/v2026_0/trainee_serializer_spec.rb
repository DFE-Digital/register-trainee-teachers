...
RSpec.describe Api::V20260::TraineeSerializer do
  ...
  describe "serialization" do
    ...
    describe "placements" do
      let(:placements) do
        trainee.placements.map { |placement| Api::V20260::PlacementSerializer.new(placement).as_hash.with_indifferent_access }
      end

      it "serializes with Api::V20260::PlacementSerializer" do
    ...
    describe "degrees" do
      let(:degrees) do
        trainee.degrees.map { |degree| Api::V20260::DegreeSerializer.new(degree).as_hash.with_indifferent_access }
      end

      it "serializes with Api::V20260::DegreeSerializer" do
    ...
    describe "HESA trainee details" do
      ...
      it "serializes with Api::V20260::HesaTraineeDetailSerializer" do
        expect(trainee.hesa_trainee_detail.attributes.except(*Api::V20260::HesaTraineeDetailSerializer::EXCLUDED_ATTRIBUTES)).to eq(hesa_trainee_detail)
      end
    end
