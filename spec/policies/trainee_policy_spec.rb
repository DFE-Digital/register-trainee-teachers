...
describe TraineePolicy do
  ...
  let(:other_training_partner_user) { user_with_organisation(create(:user, providers: []), create(:training_partner, :school)) }
  ...
  permissions :show?, :index? do
    ...
    it { is_expected.to permit(training_partner_user, training_partner_trainee) }
  ...
  describe TraineePolicy::Scope do
    let(:user_with_organisation) do
      double(
        ...
        training_partner?: is_training_partner?,
        provider?: is_provider?,
      )
    end
    let(:is_training_partner?) { false }
    ...
    context "user in lead_partner context" do
      ...
      context "where the trainee is associated with the lead partner" do
        ...
        context "and the trainee is deleted" do
          let(:trainee) { create(:trainee, :discarded, training_partner:) }
