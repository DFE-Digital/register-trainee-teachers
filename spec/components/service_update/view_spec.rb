...
describe ServiceUpdate::View do
  ...
  context "render component" do
    ...
    it "renders" do
      expect(rendered_content).to have_text("This is a title")
      expect(rendered_content).to have_text("This is a Markdown content.")
      expect(rendered_content).to have_text("8 November 2021")
    end
  end
