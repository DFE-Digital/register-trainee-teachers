  ...
  describe View, type: :component do
    context "when there is no data" do
      ...
      it "renders 'Data not available' content" do
        expect(rendered_content).to have_text("Data not available")
      end
    end
    ...
    context "when there is some missing data" do
      ...
      it "renders available data" do
        expect(rendered_content).to have_text("Abigail")
        expect(rendered_content).to have_text("McPhillips")
      end
    end
    ...
    context "when there is data" do
      ...
      it "renders the data" do
        expect(rendered_content).to have_text("Abigail")
        expect(rendered_content).to have_text("McPhillips")
        expect(rendered_content).to have_text("Pass")
      end
    end
    ...
    context "when there are multiple training instances" do
      ...
      it "renders them all" do
        expect(rendered_content).to have_text("Training instance 1")
        expect(rendered_content).to have_text("Training instance 2")
      end
    end
  end
end
