  ...
  describe View, type: :component do
    ...
    context "with an invalid form, but without errors initialised" do
      ...
      it "renders the component" do
        expect(rendered_content).to have_text("Some header content")
      end
    ...
    context "with header content" do
      it "renders the given content from the block" do
        expect(rendered_content).to have_css("p", text: invalid_data_view.summary_content)
      end
    end
    ...
    context "when the form has no errors" do
      ...
      it "does not render" do
        expect(rendered_content).not_to have_text("Some header content")
      end
    end
  end
end
