...
RSpec.describe Confirmation::Degrees::View do
  alias_method :component, :page
  before do
    render_inline(Confirmation::Degrees::View.new(data_model: trainee))
  end
  ...
  describe "Degree button text" do
    ...
    context "suppress the 'Add another degree' button" do
      before do
        render_inline(Confirmation::Degrees::View.new(data_model: trainee, show_add_another_degree_button: false))
      end
