      ...
      context "course subjects" do
        ...
        context "with one subject" do
          ...
          it "displays the correct subject summary label" do
            expect(rendered_component).to have_text(I18n.t("confirmation.confirm_publish_course.view.subject"))
          end
        end
        ...
        context "with two subjects" do
          ...
          it "displays the correct subject summary label" do
            expect(rendered_component).to have_text(I18n.t("confirmation.confirm_publish_course.view.multiple_subjects"))
          end
        end
