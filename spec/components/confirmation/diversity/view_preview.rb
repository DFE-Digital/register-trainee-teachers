...
module Confirmation
  module Diversity
    class ViewPreview < ViewComponent::Preview
      def not_disclosed
        render(View.new(data_model: mock_trainee_with_no_disclosure))
      end

      def disclosed_with_no_ethnic_group
        render(View.new(data_model: mock_trainee_with_disclosure_and_no_ethnic_group))
      end

      def disclosed_with_ethnic_group
        render(View.new(data_model: mock_trainee_with_disclosure_and_ethnic_group))
      end

      def disclosed_with_no_disabilities
        render(View.new(data_model: mock_trainee_with_disclosure_and_no_disabilities))
      end

      def disclosed_with_disabilities
        render(View.new(data_model: mock_trainee_with_disclosure_and_disabilities))
      end
