...
RSpec.describe Api::V20260::HesaTraineeDetailAttributes::Rules::FundCode do
  ...
  let(:trainee_attributes) { Api::V20260::TraineeAttributes.new(training_route:, trainee_start_date:) }
