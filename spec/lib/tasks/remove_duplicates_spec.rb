...
RSpec.describe 'trainee:remove_duplicates' do
  ...
  context 'with valid CSV file' do
    it 'removes duplicate trainees based on email' do
      trainee1 = create(:trainee, id: '123', email: 'duplicate@example.com')
      trainee2 = create(:trainee, id: '456', email: 'duplicate@example.com')
      trainee3 = create(:trainee, id: '789', email: 'duplicate@example.com')
      non_duplicate = create(:trainee, id: '890', email: 'unique@example.com')
