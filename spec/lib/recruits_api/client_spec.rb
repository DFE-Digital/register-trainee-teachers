...
module RecruitsApi
  describe Client do
    ...
    let(:http_response) { { status: 200, body: ApiStubs::RecruitsApi.applications } }
    ...
    context "when the API call fails" do
      ...
      it "raises an HttpError" do
        expect { subject }.to raise_error(RecruitsApi::Client::HttpError)
      end

      it "creates an unsuccessful ApplyApplicationSyncRequest record with recruitment_cycle_year" do
        expect do
          subject
        rescue RecruitsApi::Client::HttpError
