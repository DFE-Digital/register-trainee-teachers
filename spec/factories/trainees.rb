...
FactoryBot.define do
  factory :abstract_trainee, class: "Trainee" do
    ...
    trait :with_secondary_course_details do
      ...
      course_subject_one do
        if randomise_subjects
          Register::CodeSets::CourseSubjects::MAPPING.keys.reject { |subject| SubjectSpecialism::PRIMARY_SUBJECT_NAMES.include?(subject) }.sample
        else
    ...
    trait :with_ethnic_background do
      ethnic_background { Register::CodeSets::Ethnicities::MAPPING.keys.sample }
    end
    ...
    trait :iqts do
      ...
      iqts_country { Register::CodeSets::Countries::MAPPING.keys.sample }
    end
    ...
    trait :with_hpitt_provider do
      ...
      region { Register::CodeSets::Regions::MAPPING.keys.sample }
