...
FactoryBot.define do
  factory :api_placement_assignment, class: Hash do
    ...
    _dfe_routeid_value { Register::CodeSets::Routes::MAPPING.select { |key, _values| enabled_training_routes.include?(key) }.values.sample[:entity_id] }
    _dfe_ittsubject1id_value { Register::CodeSets::CourseSubjects::MAPPING.to_a.sample[1][:entity_id] }
    _dfe_ittsubject2id_value { Register::CodeSets::CourseSubjects::MAPPING.to_a.sample[1][:entity_id] }
    _dfe_ittsubject3id_value { Register::CodeSets::CourseSubjects::MAPPING.to_a.sample[1][:entity_id] }
    ...
    _dfe_studymodeid_value { Register::CodeSets::CourseStudyModes::MAPPING.to_a.sample[1][:entity_id] }
    _dfe_initiative1id_value { Register::CodeSets::TrainingInitiatives::MAPPING[ROUTE_INITIATIVES_ENUMS[:now_teach]][:entity_id] }
    ...
    _dfe_subjectofugdegreeid_value { Register::CodeSets::DegreeSubjects::MAPPING.to_a.sample[1][:entity_id] }
    _dfe_firstdegreeorequivalentid_value { Register::CodeSets::DegreeOrEquivalentQualifications::MAPPING.to_a.sample[1][:entity_id] }
    _dfe_classofugdegreeid_value { Register::CodeSets::Grades::MAPPING.to_a.sample[1][:entity_id] }
    _dfe_overseastrainedteachercountryid_value { nil }

    trait :with_non_uk_degree_information do
      _dfe_overseastrainedteachercountryid_value { Register::CodeSets::Countries::MAPPING.to_a.sample[1][:entity_id] }
    end
    ...
    trait :with_provider_led_bursary do
      ...
      _dfe_ittsubject1id_value { Register::CodeSets::CourseSubjects::MODERN_LANGUAGES_DTTP_ID }
      _dfe_bursarydetailsid_value { Register::CodeSets::BursaryDetails::POSTGRADUATE_BURSARY }
    end
    ...
    trait :with_early_years_salaried_bursary do
      ...
      _dfe_ittsubject1id_value { Register::CodeSets::CourseSubjects::EARLY_YEARS_DTTP_ID }
      _dfe_bursarydetailsid_value { Register::CodeSets::BursaryDetails::GRANT }
    end
    ...
    trait :with_now_teach_initiative do
      ...
      _dfe_routeid_value { Register::CodeSets::Routes::MAPPING[ROUTE_INITIATIVES_ENUMS[:now_teach]][:entity_id] }
    end

    trait :with_scholarship do
      enabled_training_routes { ["provider_led_postgrad"] }
      _dfe_ittsubject1id_value { Register::CodeSets::CourseSubjects::MODERN_LANGUAGES_DTTP_ID }
      _dfe_bursarydetailsid_value { Register::CodeSets::BursaryDetails::SCHOLARSHIP }
    end

    trait :with_no_bursary_awarded do
      enabled_training_routes { ["pg_teaching_apprenticeship"] }
      _dfe_ittsubject1id_value { Register::CodeSets::CourseSubjects::MODERN_LANGUAGES_DTTP_ID }
      _dfe_bursarydetailsid_value { Register::CodeSets::BursaryDetails::NO_BURSARY_AWARDED }
    end

    trait :primary_mathematics_specialism do
      _dfe_initiative1id_value do
        [
          Register::CodeSets::TrainingInitiatives::PRIMARY_MATHEMATICS_SPECIALISM,
          Register::CodeSets::TrainingInitiatives::PRIMARY_GENERAL_WITH_MATHS,
        ].sample
      end
    end
  end
