...
RSpec.describe "POST /api/v2025.0-rc/trainees/:trainee_id/recommend-for-qts" do
  ...
  describe "success" do
    ...
    it "recommends the trainee for a qts award" do
      post "/api/v2025.0-rc/trainees/#{trainee.slug}/recommend-for-qts",
  ...
  describe "failure" do
    context "when the trainee cannot be found" do
      ...
      it "returns status code 404" do
        post "/api/v2025.0-rc/trainees/#{other_trainee.slug}/recommend-for-qts",
             headers: { authorization: "Bearer #{token}" },
             params: { data: { qts_standards_met_date: Time.zone.today } }, as: :json
