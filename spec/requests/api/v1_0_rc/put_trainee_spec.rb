...
describe "`PUT /api/v1.0-rc/trainees/:id` endpoint" do
  let(:trainee) do
    create(
      :trainee,
      :in_progress,
  ...
  context "with an invalid authentication token" do
    ...
    it "returns status code 401 unauthorized" do
      put(
        "/api/v1.0-rc/trainees/#{trainee.slug}",
  ...
  context "with a valid authentication token" do
    ...
    let(:endpoint) { "/api/v1.0-rc/trainees/#{slug}" }
    ...
    [CourseSubjects::PHYSICS, CourseSubjects::BIOLOGY].each do |cs|
      context "when creating a new trainee with #{cs} course with valid params" do
        ...
        before do
          ...
          post "/api/v1.0-rc/trainees", params: params_for_create.to_json, headers: headers
        end
        ...
        context "with a fund_code is ineligible for funding" do
          ...
          before do
            put("/api/v1.0-rc/trainees/#{slug}", params: params_for_update.to_json, headers: headers)
          end
