...
describe "`POST /api/v1.0-rc/trainees` endpoint" do
  ...
  let(:endpoint) { "/api/v1.0-rc/trainees" }
  ...
  context "when the request is valid" do
    ...
    context "when graduation_year is an invalid 3-digit integer" do
      ...
      before do
        post "/api/v1.0-rc/trainees", params: params.to_json, headers: { Authorization: token, **json_headers }
      end
