...
describe "info endpoint" do
  ...
  context "without a valid authentication token", feature_register_api: true do
  ...
  context "with a valid authentication token and the feature flag on", feature_register_api: true do
