...
describe "`PUT /api/v2027.0/trainees/:id` endpoint" do
  ...
  context "with an invalid authentication token" do
    ...
    it "returns status code 401 unauthorized" do
      put(
        "/api/v2027.0/trainees/#{trainee.slug}",
  ...
  context "with a valid authentication token" do
    ...
    let(:endpoint) { "/api/v2027.0/trainees/#{slug}" }
  ...
  context "Updating a newly created trainee" do
    ...
    context "when the trainee doesn't have an existing hesa_trainee_detail record" do
      ...
      before do
        ...
        post "/api/v2027.0/trainees", params: params_for_create.to_json, headers: headers
      ...
      it "updates the trainee" do
        ...
        expect(trainee.funding_eligibility).to eq("not_eligible")
    ...
    [CourseSubjects::PHYSICS, CourseSubjects::BIOLOGY].each do |cs|
      context "when creating a new trainee with #{cs} course with valid params" do
        ...
        context "with a fund_code is ineligible for funding" do
          ...
          before do
            put("/api/v2027.0/trainees/#{slug}", params: params_for_update.to_json, headers: headers)
          end
