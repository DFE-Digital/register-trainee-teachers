...
describe "`POST /api/v2026.1/trainees` endpoint" do
  ...
  let(:endpoint) { "/api/v2026.1/trainees" }
  ...
  context "when the trainee_start_date is blank" do
    ...
    before do
      allow(Api::V20261::HesaMapper::Attributes).to receive(:call).and_call_original
  ...
  context "when the request is valid" do
    ...
    context "when disabilities have the same code values" do
      ...
      it "does not create a trainee record and returns a 422 status with meaningful error message" do
        post "/api/v2026.1/trainees", params: params.to_json, headers: { Authorization: token, **json_headers }
