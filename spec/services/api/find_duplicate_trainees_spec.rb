...
describe Api::FindDuplicateTrainees do
  ...
  it "does not return trainees for a different provider" do
    ...
    expect(described_class.call(provider: create(:provider), attributes: attributes)).to be_empty
  end
  ...
  it "returns trainees that are an exact match" do
    ...
    expect(described_class.call(provider: trainee.provider, attributes: attributes)).not_to be_empty
  end
