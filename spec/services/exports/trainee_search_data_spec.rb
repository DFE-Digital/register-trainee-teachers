    ...
    describe "#data" do
      let(:expected_output) do
        ...
        course = Course.find_by(uuid: trainee.course_uuid)
        {
          ...
          "course_full_or_part_time" => trainee.study_mode.humanize,
          "course_level" => "postgrad",
          "itt_start_date" => trainee.itt_start_date&.iso8601,
          "expected_end_date" => trainee.itt_end_date&.iso8601,
          "course_duration_in_years" => trainee.course_duration_in_years,
          "course_award" => course&.summary,
          ...
          "award_given_at" => trainee.awarded_at&.iso8601,
