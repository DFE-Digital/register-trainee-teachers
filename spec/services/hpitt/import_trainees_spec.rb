...
module Hpitt
  describe ImportTrainees do
    ...
    describe "#import_row" do
      ...
      subject { described_class.import_row(csv_row) }
    ...
    describe "#to_post_code" do
      ...
      subject { Hpitt::ImportTrainees.to_post_code(postcode) }
    ...
    describe "#to_ethnic_group" do
      ...
      subject { Hpitt::ImportTrainees.to_ethnic_group(ethnicity) }
    ...
    describe "build_degree" do
      subject { Hpitt::ImportTrainees.build_degree(trainee, csv_row) }
    ...
    describe "to_age_range" do
      subject { Hpitt::ImportTrainees.to_age_range(age_range) }
    ...
    describe "to_disability_ids" do
      subject { Hpitt::ImportTrainees.to_disability_ids(disabilities) }
    ...
    describe "to_school_id" do
      subject { Hpitt::ImportTrainees.to_school_id(urn) }
    ...
    describe "#to_nationality_ids" do
      subject { Hpitt::ImportTrainees.to_nationality_ids(nationalities) }
    ...
    describe "to_course_subject" do
      subject { Hpitt::ImportTrainees.to_course_subject(itt_subject) }
    ...
    describe "to_degree_grade" do
      subject { Hpitt::ImportTrainees.to_degree_grade(degree_grade) }
    ...
    describe "validate_uk_degree" do
      subject { Hpitt::ImportTrainees.validate_uk_degree(degree_type) }
    ...
    describe "#validate_degree_institution" do
      subject { Hpitt::ImportTrainees.validate_degree_institution(degree_institution) }
    ...
    describe "validate_degree_subject" do
      subject { Hpitt::ImportTrainees.validate_degree_subject(degree_subject) }
    ...
    describe "validate_enic_non_uk" do
      subject { Hpitt::ImportTrainees.validate_enic_non_uk_degree(enic) }
