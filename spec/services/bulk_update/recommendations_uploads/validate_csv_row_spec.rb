        ...
        context "When row is valid" do
          let(:row) do
            Row.new({
              ...
              "date qts or eyts requirements met" => Date.yesterday.strftime("%d/%m/%Y"),
            })
          end
        ...
        context "When date is invalid" do
          let(:row) do
            Row.new({
              ...
              "hesa id" => "12345678912345678",
              "provider trainee id" => "1234567",
              "date qts or eyts requirements met" => "21/85/2022",
            })
          end
          ...
          describe "messages" do
            it { expect(service.messages).to eql ["Date QTS or EYTS requirements met must be a valid date"] }
          end
        end
        ...
        context "When row is invalid" do
          let(:row) do
            Row.new({
              ...
              "date qts or eyts requirements met" => "not-a-date", # invalid
            })
          end
            ...
            it do
              expect(service.messages).to eql(
                [
                  ...
                  "Date QTS or EYTS requirements met must be written as dd/mm/yyyy, for example 27/02/2023",
                ],
              )
            end
          end
        ...
        context "When row contains blank strings" do
          let(:row) do
            Row.new({
              ...
              "hesa id" => "",
              "provider trainee id" => "",
              "date qts or eyts requirements met" => "",
            })
          end
