...
RSpec.describe Api::V20261::TraineeAttributes do
          ...
          context "when AcademicCycle::start_date == 2023" do
            ...
            it "includes full details in the error message" do
              ...
              expect(subject.errors[:training_route]).to include(
                "has invalid reference data value of '9'. Valid values are '03', '09', '10', '11', '12', '14', '15', '16', '17'.",
              )
            end
          end
      ...
      context "with duplicate attributes" do
        before do
          subject.degrees_attributes = [
            Api::V20261::DegreeAttributes.new(
              {
                grade: "02",
                subject: "100485",
                institution: "0117",
      ...
      context "when training_route is present" do
        context "when requires_degree? is true" do
          ...
          context "with present degrees_attributes" do
            before do
              subject.degrees_attributes = [Api::V20261::DegreeAttributes.new({})]
            end
  ...
  describe "nested attribute validations" do
    let(:placement_attributes) { [Api::V20261::PlacementAttributes.new({})] }
    let(:degrees_attributes) { [Api::V20261::DegreeAttributes.new({})] }
    let(:nationalisations_attributes) { [Api::V20261::NationalityAttributes.new({})] }
    let(:hesa_trainee_detail_attributes) { Api::V20261::HesaTraineeDetailAttributes.new({}) }
  ...
  describe ".from_trainee" do
    ...
    context "with empty params" do
      ...
      it "pulls HesaTraineeDetail attributes from association" do
        ...
        Api::V20261::HesaTraineeDetailAttributes::ATTRIBUTES.each do |attr|
