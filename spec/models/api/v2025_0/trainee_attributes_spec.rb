    ...
    describe "training_route" do
      ...
      describe "inclusion" do
        context "when trainee_start_date is present" do
          ...
          let(:unsupported_routes) { [TRAINING_ROUTE_ENUMS[:iqts], TRAINING_ROUTE_ENUMS[:assessment_only], TRAINING_ROUTE_ENUMS[:early_years_assessment_only], TRAINING_ROUTE_ENUMS[:early_years_undergrad], TRAINING_ROUTE_ENUMS[:early_years_postgrad], TRAINING_ROUTE_ENUMS[:early_years_salaried]] }
