...
RSpec.describe Api::V20270::TraineeAttributes do
      ...
      context "with duplicate attributes" do
        before do
          subject.degrees_attributes = [
            Api::V20270::DegreeAttributes.new(
              {
                grade: "02",
                subject: "100485",
                institution: "0117",
      ...
      context "when training_route is present" do
        context "when requires_degree? is true" do
          ...
          context "with present degrees_attributes" do
            before do
              subject.degrees_attributes = [Api::V20270::DegreeAttributes.new({})]
            end
  ...
  describe "nested attribute validations" do
    let(:placement_attributes) { [Api::V20270::PlacementAttributes.new({})] }
    let(:degrees_attributes) { [Api::V20270::DegreeAttributes.new({})] }
    let(:nationalisations_attributes) { [Api::V20270::NationalityAttributes.new({})] }
    let(:hesa_trainee_detail_attributes) { Api::V20270::HesaTraineeDetailAttributes.new({}) }
  ...
  describe ".from_trainee" do
    ...
    context "with empty params" do
      ...
      it "pulls HesaTraineeDetail attributes from association" do
        ...
        Api::V20270::HesaTraineeDetailAttributes::ATTRIBUTES.each do |attr|
      ...
      context "changing a single hesa trainee detail attribute" do
        ...
        let(:hesa_trainee_detail_attributes) {
          hesa_trainee_detail.attributes.select { |k, _v|
            Api::V20270::HesaTraineeDetailAttributes::ATTRIBUTES.include?(k.to_sym)
          }.merge("fund_code" => nil)
        }
