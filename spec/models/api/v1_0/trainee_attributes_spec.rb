...
RSpec.describe Api::V10::TraineeAttributes do
  ...
  describe ".from_trainee" do
    ...
    it "pulls HesaTraineeDetail attributes from association" do
      ...
      Api::V10::HesaTraineeDetailAttributes::ATTRIBUTES.each do |attr|
    ...
    let(:params) do
      {
        ...
        itt_aim: "210",
        course_study_mode: "10",
        course_year: 2024,
        course_age_range: "13918",
        pg_apprenticeship_start_date: 2.months.from_now.iso8610,
      ...
      context "changing a single hesa trainee detail attribute" do
        ...
        let(:hesa_trainee_detail_attributes) {
          hesa_trainee_detail.attributes.select { |k, _v|
            Api::V10::HesaTraineeDetailAttributes::ATTRIBUTES.include?(k.to_sym)
          }
        }
