...
RSpec.describe Api::V10::DegreeAttributes do
  let(:v10) { described_class.new(attributes, trainee:) }
  let(:attributes_with_id) { Api::V10::DegreeSerializer.new(degree).as_hash.with_indifferent_access.slice(*described_class::ATTRIBUTES) }
