...
RSpec.describe Api::V20260::TraineeAttributes do
  ...
  describe "validations" do
    ...
    it {
      expect(subject).to validate_inclusion_of(:ethnicity)
        .in_array(ReferenceData::ETHNICITIES.values.map(&:name))
    ...
    describe "training_route" do
      ...
      describe "inclusion" do
        context "when trainee_start_date is present" do
          ...
          let(:unsupported_routes) { [TRAINING_ROUTE_ENUMS[:school_direct_tuition_fee], TRAINING_ROUTE_ENUMS[:iqts], TRAINING_ROUTE_ENUMS[:assessment_only], TRAINING_ROUTE_ENUMS[:early_years_assessment_only], TRAINING_ROUTE_ENUMS[:early_years_undergrad], TRAINING_ROUTE_ENUMS[:early_years_postgrad], TRAINING_ROUTE_ENUMS[:early_years_salaried], TRAINING_ROUTE_ENUMS[:hpitt_postgrad]] }
          ...
          context "when AcademicCycle::start_date == 2023" do
            ...
            it "includes full details in the error message" do
              ...
              expect(subject.errors[:training_route]).to include(
                "has invalid reference data value of '9'. Valid values are '03', '09', '10', '11', '12', '14'.",
              )
            end
          end
      ...
      context "with duplicate attributes" do
        before do
          subject.degrees_attributes = [
            Api::V20260::DegreeAttributes.new(
              {
                grade: "02",
                subject: "100485",
                institution: "0117",
      ...
      context "when training_route is present" do
        context "when requires_degree? is true" do
          ...
          context "with present degrees_attributes" do
            before do
              subject.degrees_attributes = [Api::V20260::DegreeAttributes.new({})]
            end
  ...
  describe "nested attribute validations" do
    let(:placement_attributes) { [Api::V20260::PlacementAttributes.new({})] }
    let(:degrees_attributes) { [Api::V20260::DegreeAttributes.new({})] }
    let(:nationalisations_attributes) { [Api::V20260::NationalityAttributes.new({})] }
    let(:hesa_trainee_detail_attributes) { Api::V20260::HesaTraineeDetailAttributes.new({}) }
  ...
  describe ".from_trainee" do
    ...
    context "with empty params" do
      ...
      it "pulls HesaTraineeDetail attributes from association" do
        ...
        Api::V20260::HesaTraineeDetailAttributes::ATTRIBUTES.each do |attr|
