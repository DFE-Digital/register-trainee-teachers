...
private
  ...
  def given_registered_trainees_exist_in_the_system
    @assessment_only_trainee ||= create(:trainee, :submitted_for_trn, :with_employing_school, training_route: TRAINING_ROUTE_ENUMS[:assessment_only])
    @provider_led_postgrad_trainee ||= create(:trainee, :submitted_for_trn, training_route: TRAINING_ROUTE_ENUMS[:provider_led_postgrad])
    @biology_trainee ||= create(:trainee, :submitted_for_trn, :with_employing_school, :with_subject_specialism, subject_name: CourseSubjects::BIOLOGY)
    @history_trainee ||= create(:trainee, :submitted_for_trn, :with_employing_school, :with_subject_specialism, subject_name: CourseSubjects::HISTORY)
    @searchable_trainee ||= create(:trainee, :submitted_for_trn, :with_employing_school, trn: "123")
    @complete_trainee ||= create(:trainee, :completed, :submitted_with_start_date, :with_employing_school)
    @incomplete_trainee ||= create(:trainee, :submitted_for_trn)
    @trn_received_trainee ||= create(:trainee, :submitted_for_trn, :trn_received, :with_employing_school)
    @withdrawn_trainee ||= create(:trainee, :withdrawn)
    @early_years_trainee ||= create(:trainee, :submitted_for_trn, :early_years_undergrad)
    @primary_trainee ||= create(:trainee, :submitted_for_trn, :with_employing_school, course_age_range: DfE::ReferenceData::AgeRanges::THREE_TO_EIGHT)
    @apply_non_draft_trainee ||= create(:trainee, :submitted_for_trn, :with_apply_application, :with_employing_school)
    @dttp_import_trainee ||= create(:trainee, :submitted_for_trn, :created_from_dttp, :with_employing_school)
    @hesa_trainee ||= create(:trainee, :submitted_for_trn, :imported_from_hesa, :with_employing_school)
    @manual_trainee ||= create(:trainee, :submitted_for_trn, :created_manually, :with_employing_school)
    @api_trainee ||= create(:trainee, :submitted_for_trn, :created_from_api, :with_employing_school)
    @csv_trainee ||= create(:trainee, :submitted_for_trn, :created_from_csv, :with_employing_school)
