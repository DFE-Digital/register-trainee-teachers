...
feature "add lead partner and employing school" do
  ...
  scenario "add a lead partner and employing school", "feature_routes.school_direct_salaried": true do
    ...
    and_i_see_the_lead_partner_radio_options(false)
    and_i_choose_applicable_lead_partner_yes
    ...
    and_i_see_the_employing_school_radio_options(false)
    and_i_choose_applicable_employing_school_yes
    and_i_click_on_continue
  ...
  def and_i_see_the_lead_partner_radio_options(value)
    expect(edit_trainee_lead_partner_details_page).to have_lead_partner_radio_button_checked(value)
  end

  def and_i_choose_applicable_lead_partner_yes
    edit_trainee_lead_partner_details_page.select_radio_button(false)
  end
  ...
  def and_i_see_the_employing_school_radio_options(value)
    expect(edit_trainee_employing_school_details_page).to have_employing_school_radio_button_checked(value)
  end

  def and_i_choose_applicable_employing_school_yes
    edit_trainee_employing_school_details_page.select_radio_button(false)
  end
