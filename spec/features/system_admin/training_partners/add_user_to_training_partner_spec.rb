...
feature "Add user to training partners" do
  ...
  context "as a system admin" do
    ...
    scenario "list training partners page" do
      ...
      when_i_select_a_training_partner
      and_i_click_the_submit_button
      then_i_see_the_user_added_to_the_training_partner

      when_i_click_the_training_partner_link
      then_i_see_the_training_partner_detail_page
      and_i_see_the_user_has_been_added_to_the_training_partner

      when_i_visit_the_user_page
      and_i_click_the_remove_link
      then_i_see_the_remove_training_partner_page

      when_i_confirm_the_removal
      then_i_see_a_flash_message_to_confirm_the_removal
      and_i_no_longer_see_the_training_partner_on_the_user_page
    end
  end
  ...
  context "as a system admin using the non-JS flow" do
    ...
    scenario "list training partners page" do
      ...
      when_i_select_a_training_partner_from_search_results
      then_i_see_the_user_added_to_the_hei_training_partner
    end
  end
