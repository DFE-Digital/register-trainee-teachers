...
feature "edit schools spec" do
  context "as a school direct salaried trn_submitted trainee" do
    ...
    scenario "changing the training partner", js: true do
      when_i_see_the_training_partner
      and_i_click_on_change_training_partner(:training_partner)
      ...
      and_i_click_the_first_item_in_the_list_training_partner
      and_i_continue
      then_i_am_redirected_to_the_confirm_schools_page
      and_i_see_the_updated_training_partner
    end
    ...
    scenario "choosing not applicable for training partner" do
      ...
      and_i_continue
      then_i_am_redirected_to_the_confirm_schools_page
      and_the_training_partner_displays_not_applicable
    end
...
private
  ...
  def given_a_school_direct_tuition_fee_trainee_submitted_for_trn_exists
    given_a_trainee_exists(:completed, :school_direct_tuition_fee, :with_training_partner, :submitted_for_trn)
  end
  ...
  def and_i_click_the_first_item_in_the_list_training_partner
  ...
  def and_a_number_of_training_partners_exist
    @training_partners = create_list(:training_partner, 1, :school)
  end
  ...
  def and_i_click_on_change_training_partner(training_partner)
    record_page.public_send("change_#{training_partner}").click
  end
  ...
  def and_the_training_partner_displays_not_applicable
