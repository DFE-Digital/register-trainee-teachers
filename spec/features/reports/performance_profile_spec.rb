...
feature "performance profile" do
  context "outside the performance profile period" do
    background do
  ...
  context "within the performance profile period" do
    background do
    ...
    context "accredited provider user" do
      ...
      scenario "user signing off the performance profile from reports page" do
        ...
        and_i_click_on("Trainees who studied in the 2023 to 2024 academic year report")
        and_i_am_on_the_sign_off_your_performance_profile_page
