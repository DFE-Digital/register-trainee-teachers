...
module PageObjects
  module Trainees
    class TrainingPartnersSearch < PageObjects::Base
      ...
      element :search_again_option, "input#partners-training-partner-form-training-partner-id-results-search-again-field"
      ...
      def choose_training_partner(id:)
        find("#partners-training-partner-form-training-partner-id-#{id}-field").choose
      end
    end
  end
end
