...
module WithdrawalReasons
  ...
  LEGACY_MAPPING = {
    ...
    UNKNOWN => TRAINEE_CHOSE_TO_WITHDRAW_ANOTHER_REASON,
    DEATH => HAD_TO_WITHDRAW_TRAINEE_ANOTHER_REASON,
    EXCLUSION => HAD_TO_WITHDRAW_TRAINEE_ANOTHER_REASON,
    WRITTEN_OFF_AFTER_LAPSE_OF_TIME => HAD_TO_WITHDRAW_TRAINEE_ANOTHER_REASON,
    FINANCIAL_PROBLEMS => CHANGE_IN_PERSONAL_OR_HEALTH_CIRCUMSTANCES,
    PROBLEMS_WITH_THEIR_HEALTH => CHANGE_IN_PERSONAL_OR_HEALTH_CIRCUMSTANCES,
    GOT_A_JOB => HAD_TO_WITHDRAW_TRAINEE_ANOTHER_REASON,
    DID_NOT_PASS_ASSESSMENT => MANDATORY_REASONS,
    COURSE_WAS_NOT_SUITABLE => ANOTHER_REASON,
    DID_NOT_PASS_EXAMS => TRAINEE_CHOSE_TO_WITHDRAW_ANOTHER_REASON,
    PERSONAL_REASONS => CHANGE_IN_PERSONAL_OR_HEALTH_CIRCUMSTANCES,
    FAMILY_PROBLEMS => CHANGE_IN_PERSONAL_OR_HEALTH_CIRCUMSTANCES,
    TRANSFERRED_TO_ANOTHER_PROVIDER => MOVED_TO_DIFFERENT_ITT_COURSE,
  }.freeze
