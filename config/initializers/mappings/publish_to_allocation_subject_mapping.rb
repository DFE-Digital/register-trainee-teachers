...
PUBLISH_PRIMARY_SUBJECT_SPECIALISM_MAPPING = {
  ...
  PublishSubjects::PRIMARY_WITH_MATHEMATICS => [CourseSubjects::PRIMARY_TEACHING, CourseSubjects::MATHEMATICS],
  ...
  PublishSubjects::PRIMARY_WITH_SCIENCE => [CourseSubjects::PRIMARY_TEACHING, CourseSubjects::GENERAL_SCIENCES],
}.freeze
...
PUBLISH_SECONDARY_SUBJECT_SPECIALISM_MAPPING = {
  ...
  "Physical education with an EBacc subject" => ALLOCATION_SUBJECT_SPECIALISM_MAPPING[AllocationSubjects::PHYSICAL_EDUCATION],
