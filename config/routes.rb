...
Rails.application.routes.draw do
  ...
  resources :reports, only: :index do
    get "itt-new-starter-data-sign-off", to: "reports_controller#itt_new_starter_data_sign_off", on: :collection
    ...
    collection do
      scope module: :reports, as: :reports do
        resources :performance_profiles, only: %i[index show new create destroy]
      end
    end
  end
