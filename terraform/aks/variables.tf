...
locals {
  ...
  app_env_values = merge(
    ...
    local.app_config,
    {
      ...
      BIGQUERY_POLICY_TAGS                        = var.airbyte_enabled ? "{ 'extrahidden': 'projects/rugged-abacus-218110/locations/europe-west2/taxonomies/69524444121704657/policyTags/4958740409786931588', 'hidden': 'projects/rugged-abacus-218110/locations/europe-west2/taxonomies/69524444121704657/policyTags/6523652585511281766' }" : null
