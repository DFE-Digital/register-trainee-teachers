...
```ruby
# app/models/api/v2025_0/trainee_attributes.rb
...
```sh
rails "api:generate_new_version[v2025.0,v2026.0]"
```
...
```ruby
# app/models/api/v2026_0/trainee_attributes.rb
...
```sh
rails "api:generate_new_spec_version[v2025.0,v2026.0]"
```
...
- Ensure that the version format provided is `vx.x` (for example `v2025.0` or `v2026.0`).
